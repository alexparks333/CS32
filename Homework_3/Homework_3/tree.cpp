...
//  Homework_3
//
//  Created by Anirudh Balasubramaniam on 2/10/18.
...
{
    if(n <= 1) return;
    int firstNG = 0, firstLess = 0;
    split(a, n, a[n/2], firstNG, firstLess);
    order(a, firstNG);
...
//int main()
//{
//    double a [6] ={1,3,22,1,12,3};
//    double b [2] ={1,3};
//
//    cout<<countIncludes(a, 6, b, 2);
////    order(a, 6);
////
////    for(int i = 0; i < 6; i++)
////    {
